        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="submit" class="btn btn-sm btn-outline-primary float-right" id="btnCetak" data-toggl="modal" data-target="#mdlPeriodeJual"><i class="fas fa-print"></i> Cetak</button>
                </div>
