...
$title = "Laporan Pembelian | Kasir Ukom";
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-list"></i> Data Pembelian</h3>
                    <button type="submit" class="btn btn-sm btn-outline-primary float-right" id="btnCetak" data-toggl="modal" data-target="#mdlPeriodeBeli"><i class="fas fa-print"></i> Cetak</button>
                </div>
