...
$title = "Change Password | Kasir Ukom";
            ...
            <div class="card">
                <form action="" method="post">
                    <div class="card-header">
                        ...
                        <button type="submit" name="simpan" class="btn btn-sm btn-primary float-right"><i class="fas fa-edit"></i> Submit</button>
                        <button type="submit" name="reset" class="btn btn-sm btn-danger float-right mr-1"><i class="fas fa-times"></i> Reset</button>
                    </div>
                    <div class="card-body">
                        <div class="col-lg-8 mb3">
                            <div class="form-group">
                                <label for="currPass">Current Password</label>
                                <input type="password" name="currPass" id="currPass" class="form-control" placeholder="masukkan password anda saat ini" required>
                                <?php if ($msg == 'err2') {
                                    echo $alert2;
                                } ?>
                            </div>
